...
button.setStyleSheet(f"font-size: 18px; padding: 10px 20px; background-color: {color}; color:
{'#000' if button_text == '=' else '#fff'}; border: none; border-radius: 50%;")
...
result = self.controller.calculate(expression) self.input_field.setText(result)
elif text == "C":
